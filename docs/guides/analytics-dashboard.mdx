...
sidebarTitle: "Event Tracking Best Practices"
---
...
<Note>
  **Custom Analytics UIs**: Build custom analytics dashboards using the [Query API](/guides/query-api). The Query API allows you to programmatically access your analytics data and create tailored experiences.
</Note>
